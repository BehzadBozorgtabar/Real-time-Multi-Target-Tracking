...
from functions.cython_bbox import bbox_ious
from functions import kalman_filter
...
def nearest_feature_distance(tracks, detections, metric='cosine'):
    """
    Compute cost based on appearance features
    """
...
def mean_feature_distance(tracks, detections, metric='cosine'):
    """
    Compute cost based on appearance features
    """
